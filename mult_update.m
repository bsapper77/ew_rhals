function [W,H,step,error_converge,cost_converge,adj_cost,l1cost,l2cost]=mult_update(A,k,alpha,beta,gamma,delta,tolerance,maxsteps,initialize,SigmaMat,sigma,range)
rng(range);
conv_by_cost=true;
proj_grad=false;
proj_back=true;
